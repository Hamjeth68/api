...
var MIMEType__default = /*#__PURE__*/_interopDefaultLegacy(MIMEType);
...
function readMultipartWebStream(response, mimeType) {
  ...
  return {
    ...
    observable: new zenObservableTs.Observable(observer => {
...
function executeOperation({
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    promise.then(response => __awaiter(this, void 0, void 0, function* () {
      ...
      const mimeType = contentType && new MIMEType__default["default"](contentType);
...
class SubscriptionClient {
  ...
  get multipartClient() {
    ...
    const client = (_a = this._multipartClient) !== null && _a !== void 0 ? _a : Object.assign(new EventEmitter__default["default"](), {
    ...
    if (data && 'name' in data) {
      ...
      if ((isQueryOrMutation || isSubscription) && data.operation && data.operationId) {
        ...
        if (isQueryOrMutation) {
          const {
            includeCookies
          } = data; // we support the old way of using the embed when we didn't require folks to have
...
var homepage = "https://github.com/apollographql/embeddable-explorer/explorer#readme";
...
class EmbeddedExplorer {
  constructor(options) {
    ...
    this.getEmbeddedExplorerURL = () => {
      ...
      const queryParams = Object.assign(Object.assign(Object.assign({
        ...
        shouldShowGlobalHeader: (displayOptions === null || displayOptions === void 0 ? void 0 : displayOptions.showGlobalHeader) == undefined ? true : false,
  ...
  validateOptions() {
    ...
    if (this.options.includeCookies !== undefined) {
      console.warn('Passing `includeCookies` is deprecated. Remove `includeCookies` from your config, and use the setting for your variant on Studio to set whether or not to include cookies.');
    }
